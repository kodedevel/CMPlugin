...
abstract class CreateSitemap : DefaultTask(), Configurable, TaskRunnable {
    ...
    private fun createSitemap(category: String) {
        ...
        sitemapFile = rootHTMLDirectory.file("map_$category.xml").get().asFile
    ...
    private fun createSitemapForHomePage() {
        sitemapFile = rootHTMLDirectory.file("map_home.xml").get().asFile
    ...
    companion object {
        ...
        private const val SITEMAP_INDEX_NAME = "map_index.xml"
    }
}